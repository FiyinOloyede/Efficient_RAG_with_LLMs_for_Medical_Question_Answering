...
# Load pre-chunked documents from pickle
...
vector_db_gtr = 'vector_store_gtr-t5-large'
...
# Create a retriever for dense embeddings
dense_retriever_gtr = index.as_retriever(search_kwargs={"k": 5})


vector_db_gtr2 = 'vector_store_gtr-t5-large2' #Knowledge base build (with dataset contexts)
...
vector_db_sbb = 'vector_store_pritamdeka'
...
vector_db_sbb2 = 'vector_store_pritamdeka2'  #Knowledge base build (with dataset contexts)
